...
bucket='streamlitappserver-s3bucket-bww6pgzxljts'
prefix='gen-ai-qa'
...
def first_column():
            ...
            st.markdown("<p style='color:#5A5A5A;'>🤝 I use RAG (Retrieval Augmented Generation) architecture to understand your documents and provide accurate answers. Think of me as your personal research assistant who has carefully read and understood everything you share. </p>",unsafe_allow_html=True)
            st.write(" ")
            st.write(" ")
            st.write(" ")            
            st.markdown("<span style='color:#5A5A5A;'>🛠️ Built on [Amazon Bedrock's](https://aws.amazon.com/bedrock/) LLMs with Titan Embeddings, I combine [LangChain's](https://python.langchain.com/en/latest/index.html) processing power and [FAISS](https://python.langchain.com/docs/integrations/vectorstores/faiss/) is used as in-memory vector store vector storage to deliver fast, accurate responses through a [Streamlit](https://streamlit.io/) interface.</span>", unsafe_allow_html=True)
            st.write(" ")
            st.write(" ")
            st.markdown("<p style='color:#5A5A5A;'> 📈 Stay tuned for more features including multi-page website analysis, embedded link processing, and advanced spreadsheet handling capabilities.</p>", unsafe_allow_html=True)
            st.write(" ")        
            st.write(" ")
...
def second_column():
            ...
            st.write(" ")
            st.write("")
            st.markdown("<span style='color:#5A5A5A;'>🔍  Choose Your Source<br>Simply select documents, web pages, or images from the sidebar to begin exploring.</span>", unsafe_allow_html=True)            
            st.write(" ")
            st.markdown("<span style='color:#5A5A5A;'>💬 Start the Conversation<br>Your AI assistant is ready! Ask questions, generate summaries, or explore talking points - all at your fingertips.</span>", unsafe_allow_html=True)
...
def third_column():
            ...
            st.markdown("<p style='color:#5A5A5A;'>⚡ Deploy containerized apps serverlessly with AWS Fargate. </p>",unsafe_allow_html=True)
            
            st.markdown("<p style='color:#5A5A5A;'>⚡ Analysis of spreadsheets with charts and insights.",unsafe_allow_html=True)
            st.markdown("<p style='color:#5A5A5A;'>⚡ Use 3rd party models and embeddings hosted on Sagemaker.",unsafe_allow_html=True)
            st.markdown("<p style='color:#5A5A5A;'>⚡ Flexible vector store integration with popular databases",unsafe_allow_html=True)
...
def heads():
    st.markdown("<h3 style='text-align:center;'>👋🏽 Hey There! I'm <span style='color:#4B91F1'>LOKI</span>!🤖</h3>",unsafe_allow_html=True)
    st.markdown("""
    <p style='text-align:center;'>Your AI-powered document companion that makes information instantly accessible. I can help you with:</p>
    ...
    st.markdown("<h6 style='text-align:center;'> ✨ Just upload your content and ask me anything! ✨</h6>",unsafe_allow_html=True)
